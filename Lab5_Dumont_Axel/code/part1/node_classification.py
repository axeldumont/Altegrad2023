...
print("Accuracy DeepWalk:", accuracy_score(y_test, y_pred))
...
DinvMat = diags(Dinv)
Lrw = DinvMat @ A @ DinvMat

# Find smallest eigenvalues 
lambda_min = eigs(Lrw, k=2, which='SM') 
...
print("Accuracy Spectral Embeddings:", accuracy_score(y_test, y_pred))